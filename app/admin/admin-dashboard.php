  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">kost pak Rudi</div>
      </a>
          ...
          <div class="row">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <?php
                      // Periksa apakah data_bulan ada dan tidak kosong
                      if ($data_bulan && $data_bulan['pendapatan_bulan'] > 0) {
                        // Jika ada pendapatan, tampilkan jumlah pendapatan
                        echo '<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Pendapatan (' . $data_bulan['bulan_sekarang'] . ')</div>';
                        echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Rp ' . number_format($data_bulan['pendapatan_bulan']) . '</div>';
                      } else {
                        // Jika tidak ada pendapatan, tampilkan pesan
                        echo '<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Pendapatan</div>';
                        echo '<div class="h5 mb-0 font-weight-bold text-gray-800">Belum ada pendapatan bulan ini</div>';
                      }
                      ?>
                    </div>
                    <div class="col-auto">
            ...
            $query = "
             SELECT 
                 ...
                 SUM(pembayaran.nilai_pembayaran) AS pendapatan_tahun, 
                 YEAR(pembayaran.tanggal_pembayaran) AS tahun_sekarang
             FROM pembayaran
             WHERE pembayaran.id_status = 1 
               AND YEAR(pembayaran.tanggal_pembayaran) = YEAR(CURRENT_DATE)
             GROUP BY YEAR(pembayaran.tanggal_pembayaran)
             HAVING SUM(pembayaran.nilai_pembayaran) > 0
             LIMIT 12;
         ";
            ...
            if ($data_tahun) {
              $tahun_sekarang = $data_tahun['tahun_sekarang'];
              $pendapatan_tahun = number_format($data_tahun['pendapatan_tahun']);
            } else {
              $tahun_sekarang = date('Y'); // Default ke tahun saat ini
              $pendapatan_tahun = 0; // Default ke 0
            }
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                        Pendapatan (<?php echo $tahun_sekarang; ?>)
                      </div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        Rp <?php echo $pendapatan_tahun; ?>
                      </div>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="row">
                      <div class="col-2">
                        ...
                        <?php if ($pembayaran_terbaru['foto_pengguna'] == NULL) { ?>
                          ...
                          <img class="rounded-circle mt-1" width="40px" height="40px" src="../../assets/img/uploadDb/none.png" alt="">

                        <?php } else { ?>

                          <img class="rounded-circle mt-1" width="40px" height="40px" src="../../assets/img/uploadDb/<?php echo $pembayaran_terbaru['foto_pengguna']; ?>" alt="">
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; kost pak rudi 2024</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
    ...
    <script>
      ...
      var myLineChart = new Chart(ctx, {
        ...
        data: {
          labels: [
            <?php
            // Query untuk mendapatkan nama bulan sebagai label
            $query = "SELECT DATE_FORMAT(pembayaran.tanggal_pembayaran, '%M %Y') AS bulan
                FROM pembayaran
                WHERE pembayaran.id_status = 1
                GROUP BY MONTH(pembayaran.tanggal_pembayaran), YEAR(pembayaran.tanggal_pembayaran)
          ...
          datasets: [{
            ...
            data: [
              ...
              $query = "SELECT SUM(pembayaran.nilai_pembayaran) AS pendapatan_bulanan
                  FROM pembayaran
                  WHERE pembayaran.id_status = 1
                  GROUP BY MONTH(pembayaran.tanggal_pembayaran), YEAR(pembayaran.tanggal_pembayaran)
                  ORDER BY pembayaran.tanggal_pembayaran ASC";
