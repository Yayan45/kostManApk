    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        if (isset($_SESSION['akun_id'])) {
          ...
          $query = "SELECT *, kamar.harga_bulanan,kamar.foto_kamar, kamar.harga_bulanan AS harga_kamar_bulanan 
            FROM pengguna 
            JOIN menghuni ON pengguna.id_pengguna = menghuni.id_pengguna 
              ...
              <div class="card col-12 mb-3">
                <div class="card-body">
                  ...
                  <div class="container-fluid pr-3">
                    <img src="<?php echo '../../assets/img/uploadDb/' . $data['foto_kamar']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded"
                      width="400px">
