...
?>
  ...
  <head>
    ...
    <title id="tittle">Laporan Pendapatan <?php echo $namaBulan . ' ' . $tahun; ?></title>
    <style type="text/css">
      .style1 {
        font-size: large
      }
    ...
    <table width="910" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="4" align="center">
          <strong class="style1">LAPORAN PENDAPATAN</strong>
        </td>
      </tr>
      <tr>
        <td colspan="4" align="center">
      ...
      <?php $pemasukan = $dataPembayaran['total_pembayaran'];
      $pengeluaran = $dataPengeluaran['total_pengeluaran']; ?>
      <tr height="30px">
        <td width="25%"><strong>KEUNTUNGAN BERSIH</strong></td>
  ...
  ?>
    ...
    <head>
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <meta http-equiv="X-UA-Compatible" content="ie=edge">
      <title id="tittle">LAPORAN PENDAPATAN <?php echo $tahun; ?></title>
      <style type="text/css">
        .style1 {
          font-size: large
        }
