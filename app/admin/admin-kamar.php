      ...
      <script>
        $(document).ready(function() {
          ...
          $(document).on('click', '.edit_data', function() {
            ...
            $.ajax({
              url: "ajax/edit_data_kamar.php", // Ganti dengan URL file PHP Anda
              method: "POST",
              data: {
                id_kamar: id_kamar
              },
              success: function(response) {
                console.log("Server Response:", response); // Tampilkan respon server
                $('#detail_edit').html(response); // Masukkan respon ke elemen
