          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <?php
                $id = $_SESSION['akun_id'];
                $query = "SELECT id_pengguna, foto_pengguna FROM pengguna WHERE id_pengguna = $id;
";
                ...
                ?>
                  ...
                  <?php } else { ?>
                    ...
                    <img class="img-profile rounded-circle" src="<?php echo '../../assets/img/uploadDb/' . $data['foto_pengguna']; ?>">
            ...
            <div class="card col-12">
              <div class="card-body">
                ...
                if (isset($_SESSION['akun_id'])) {
                  ...
                  $query = "SELECT * 
                            FROM info_kost 
                              INNER JOIN pengguna ON info_kost.id_pengguna = pengguna.id_pengguna 
                              WHERE info_kost.id_pengguna = pengguna.id_pengguna;
                              ";
                  $result = mysqli_query($conn, $query);
                ...
                ?>
                    <div class="container-fluid pr-3">
                      <img src="../../assets/img/uploadDb/<?php
