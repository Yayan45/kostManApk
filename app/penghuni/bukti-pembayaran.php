  ...
  <body>
    ...
    <table width="910" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr height="30px">
        ...
        <td></td>
        <td colspan="2">
          <div align="center"><img width="200px" src="../../images/ttdscan.png" alt="TTD PEMILIK"></div>
        </td>
      </tr>
      <tr height="30px">
        <td></td>
        <td></td>
        <td colspan="2">
          <div align="center"><strong><?php echo strtoupper($dataPemilik['nama_pengguna']); ?></strong>
        </td>
      </tr>
    </table>
