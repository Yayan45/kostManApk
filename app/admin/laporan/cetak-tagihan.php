...
if (isset($_POST['cetakBulan'])) {
  ...
  SELECT 
        ...
        COALESCE(SUM(pengeluaran.nilai_pengeluaran), 0) AS total_pengeluaran, 
        COALESCE(MAX(pengeluaran.tanggal_pengeluaran), '-') AS tanggal_pengeluaran, 
        DATE_FORMAT(CURRENT_DATE(), '%d %M %Y') AS tanggal_cetak
    FROM 
        jenis_pengeluaran
    LEFT JOIN 
        pengeluaran 
    ON 
        ...
        AND YEAR(pengeluaran.tanggal_pengeluaran) = '$tahun' 
        AND MONTH(pengeluaran.tanggal_pengeluaran) = '$bulan'
    GROUP BY 
        jenis_pengeluaran.nama_pengeluaran
  ";
      ...
      <tr>
        <td width="100%" colspan="4">
          <div align="center" class="style1"><strong><?php echo strtoupper($dataKost['nama_kost']); ?></strong><br>
            ...
            E-Mail : <?php echo $dataKost['email_kost']; ?>, Telp : <?php echo $dataKost['no_kost']; ?> </div>
        </td>
      <tr>
        <td colspan="4"></td>
      </tr>
