    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          $query2 = "SELECT *, DATE_FORMAT(CURRENT_DATE(), '%M %Y') AS bulan, (kamar.harga_bulanan ) AS harga_total, CURRENT_DATE() AS tanggal_sekarang FROM kamar, pengguna, menghuni
            WHERE menghuni.id_kamar = kamar.id_kamar   AND
            ...
            <div class="card col-12 mb-3">
              <div class="card-body">
                ...
                <div class="container-fluid pr-3">
                  <img src="<?php echo '../../assets/img/uploadDb/' . $dataPembayaran['bukti_pembayaran']; ?>" alt="<?php echo $dataPembayaran['tanggal_pembayaran']; ?>" class="img-thumbnail mx-auto d-block mb-3 rounded"
                    width="300px">
